...
list-projects:
	...
	@echo "              cancer-immune-sample virus-macrophage-sample template ECM-single ECM-multi"

ECM-single:
	cp ./sample_projects/ECM_single/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./sample_projects/ECM_single/main.cpp ./main.cpp
	cp Makefile Makefile-backup
	cp ./sample_projects/ECM_single/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml
	cp ./sample_projects/ECM_single/config/* ./config/

ECM_multi:
	cp ./sample_projects/ECM_multi/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./sample_projects/ECM_multi/main.cpp ./main.cpp
	cp Makefile Makefile-backup
	cp ./sample_projects/ECM_multi/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml
	cp ./sample_projects/ECM_multi/config/* ./config/
